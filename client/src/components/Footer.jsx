      ...
      <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
        <div className='max-w-80'>
          <div className='flex items-center gap-2 mb-4'>
            ...
            {/* <span className='text-xl font-bold text-slate-800 tracking-tight'>Quick Ai</span> */}
          </div>
          <p className='text-sm'>
            Quick Ai is an advanced AI-powered platform that enables creators to generate professional-quality content, from stunning visuals to compelling copy, in just seconds.
          </p>
